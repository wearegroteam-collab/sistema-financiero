...
5. El setup inicial crea solo el Super Admin global con `business_id = null`. Los negocios se crean despues desde el panel Super Admin.
6. Si vienes de una version anterior, ejecuta tambien `supabase/migrations/0002_global_super_admin_cleanup.sql` para despegar cualquier Super Admin que haya quedado asociado a un negocio.
